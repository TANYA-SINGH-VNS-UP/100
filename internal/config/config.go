...
func LoadConfig() error {
	...
	Conf = &BotConfig{
		...
		ApiUrl:         getEnvStr("API_URL", "https://api.vniox.store"),
		ApiKey:         os.Getenv("API_KEY"),
		OwnerId:        getEnvInt64("OWNER_ID", 6972508083),
		LoggerId:       getEnvInt64("LOGGER_ID", -1001511253627),
		...
		SupportGroup:   getEnvStr("SUPPORT_GROUP", "https://t.me/Nobita_Support"),
		SupportChannel: getEnvStr("SUPPORT_CHANNEL", "https://t.me/Heroku_club"),
